...
export default function BloodRequests() {
    ...
    useEffect(() => {
        const fetchRequests = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_APP_BACKEND_URL}/donor/blood-requests/${userId}`);
    ...
    const handleStatusUpdate = async (requestId, status) => {
        try {
            await axios.post(`${import.meta.env.VITE_APP_BACKEND_URL}/donor/update-request`, { requestId, status });
